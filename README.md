...
![Version](https://img.shields.io/badge/version-4.2.0-pink)
...
- ✅ **達成可能性の警告** ⚠️：物理的に不可能な条件（週7日超・月31日超）を自動検出して警告
...
- **達成可能性判定** ⚠️：物理的に不可能な条件を自動検出して警告表示
  - 週7日超または月31日超の勤務が必要な場合に警告
  - 具体的な改善提案を表示（目標金額の調整、期間延長、単価アップ、固定費削減）
...
### v4.2.0 (2025-12-04) ⚠️
- ⚠️ **不可能な達成条件の警告機能を実装**
  - 週の勤務日数が7日超、または月の勤務日数が31日超の場合に警告表示
  - 「達成不可能」と「条件の見直し推奨」の2段階警告
  - 具体的な改善提案を表示（目標金額の調整、期間延長、単価アップ、固定費削減など）
- 🎨 **警告メッセージのデザイン追加**
  - 赤色警告（達成不可能）とオレンジ色警告（見直し推奨）
  - アイコンとビジュアルで直感的に理解可能
- 📱 **スマホ対応の警告UI**
